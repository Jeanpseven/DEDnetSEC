...
while True:
    ...
    print(f"SSID: {chosen_network.ssid}")
    print(f"BSSID: {chosen_network.bssid}")
    print(f"Frequência: {chosen_network.freq} MHz")
    print(f"Sinal: {chosen_network.signal} dBm")
    print(f"Canal: {chosen_network.channel}")
    print(f"Fabricante: {obter_nome_fabricante(bssid)}")
